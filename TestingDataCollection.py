...
while True:
    ...
    count = {
                'zero': len(os.listdir(directory+"C:/Users/DARSI LAHARI/Downloads/Sign-Language-To-Text-Conversion-main/Sign-Language-To-Text-Conversion-main/dataSet/testingData/0")),
